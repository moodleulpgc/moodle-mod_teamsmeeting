...
/**
 * The task that provides a complete restore of mod_teamsmeeting is defined here.
 *
...
class restore_teamsmeeting_activity_task extends restore_activity_task {
    ...
    static public function define_decode_contents() {
        ...
        $contents[] = new restore_decode_content('teamsmeeting', array('intro'), 'teamsmeeting');
    ...
    static public function define_decode_rules() {
        ...
        $rules[] = new restore_decode_rule('TEAMSMEETINGVIEWBYID',
                                           '/mod/teamsmeeting/view.php?id=$1',
                                           'course_module');
        $rules[] = new restore_decode_rule('TEAMSMEETINGINDEX',
                                           '/mod/teamsmeeting/index.php?id=$1',
                                           'course_module');
     ...
     * {@link restore_logs_processor} when restoring mod_teamsmeeting logs. It
