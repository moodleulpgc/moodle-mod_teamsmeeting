...
/**
 * The meeting_joined event class.
 *
 * @package    mod_teamsmeeting
 * @copyright  2020 Enrique Castro <@ULPGC>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class meeting_joined extends \core\event\base {
    ...
    public function get_description() {
        ...
        return "$usertext has joined the videoconference '{$this->other['meetingidid']}' in teamsmeeting activity with id '$this->objectid' 
    ...
    public static function get_name() {
        return get_string('eventmeetingjoined', 'mod_teamsmeeting');
    }
